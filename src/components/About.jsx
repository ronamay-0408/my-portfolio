  ...
  return(
    <section className="relative min-h-screen flex pt-60 justify-center bg-white dark:bg-gray-900 dark:border-gray-700">
      ...
      <div className="relative z-10 text-center px-4">
        ...
        <h2 className="text-xl md:text-3xl text-gray-600 dark:text-gray-300 mb-8">
        ...
        <div className="flex gap-4 justify-center">
          ...
          <a
            ...
            className="px-6 py-3 border border-gray-900 dark:border-white text-gray-900 dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg transition-colors"
          >
            My works
          </a>
        </div>
