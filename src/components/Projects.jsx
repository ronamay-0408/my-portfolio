...
const projects = [
  {
    ...
    cover: '/projects/voting-system.png',
    screenshots: ['/projects/voting-system.png'],
    category: 'Web App',
    color: '#7c3aed',
  },
  {
    ...
    tech: ['Java'],
    cover: '/projects/inventory-system-java.png',
    screenshots: ['/projects/inventory-system-java.png'],
    category: 'Web System',
    color: '#0ea5e9',
  },
  {
    ...
    cover: '/projects/glassesEcom/1.png',
    screenshots: Array.from({ length: 2 }, (_, i) => `/projects/glassesEcom/${i + 1}.png`),
    category: 'E-Commerce',
    color: '#E34F26',
  },
  {
    ...
    cover: '/projects/busina/1.png',
    screenshots: Array.from({ length: 5 }, (_, i) => `/projects/busina/${i + 1}.png`),
  ...
  },
  {
    ...
    cover: '/projects/iraya/1.png',
    screenshots: Array.from({ length: 8 }, (_, i) => `/projects/iraya/${i + 1}.png`),
    category: 'Website',
    color: '#FF2D20',
  },
  {
    ...
    cover: '/projects/coe/1.png',
    screenshots: Array.from({ length: 8 }, (_, i) => `/projects/coe/${i + 1}.png`),
    category: 'Web System',
    color: '#4479A1',
  },
];
